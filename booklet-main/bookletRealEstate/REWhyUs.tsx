...
const valueProps = [
  {
    ...
    body: "Strategy sprints from $4k. Custom builds $8k–$30k for most real estate engagements. Boutique outcomes at a fraction of enterprise AI pricing.",
    accent: "brand" as const,
  },
  {
    icon: UserCheck,
    title: "Human-verified, not just AI-generated",
    body: "Every property match, every lead recommendation, every tenant communication goes through a human review step. AI surfaces the data; your team makes the call.",
    accent: "accent" as const,
  },
  {
    icon: Layers,
    title: "Shipped, not stalled",
    body: "Live in your operation in 3–6 weeks. No 80-slide strategy decks before something actually ships. Weekly demos from day one.",
    accent: "brand" as const,
  },
  {
    icon: ShieldCheck,
    title: "Owned, not rented",
    body: "Code, data, and integrations live in your cloud accounts. No vendor lock-in, no per-seat tax as your portfolio grows.",
    accent: "accent" as const,
  },
];
