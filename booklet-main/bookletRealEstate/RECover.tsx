    ...
    <Poster page="01 / 08" section="Cover" showWatermark={false}>
      ...
      <div className="flex h-full min-h-[260mm] flex-col justify-between">
        <div className="flex items-start justify-between">
          ...
          >
            <Building2 className="size-3 text-[var(--color-accent)]" />
            For Property Dealers &amp; Real Estate · 2026 Edition
          </motion.div>
        </div>
        ...
        <div>
          <motion.h1
            ...
            className="poster-title mt-5 text-[54px] leading-[0.96]"
          >
            <span className="text-gradient-brand">Respond in seconds.</span>
            <br />
            <span className="text-gradient">Close with a human.</span>
            <br />
            <span className="text-[var(--color-fg-muted)]">Every time.</span>
          </motion.h1>
          ...
          >
            A boutique AI consultancy that builds instant inquiry response bots,
            rent tracking systems, property matching engines, and tenant
            management workflows for property dealers and real estate businesses.
            Everything wires directly into your listing system, WhatsApp, and CRM.
          </motion.p>
        </div>
