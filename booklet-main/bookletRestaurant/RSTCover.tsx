    ...
    <Poster page="01 / 08" section="Cover" showWatermark={false}>
      ...
      <div className="flex h-full min-h-[260mm] flex-col justify-between">
        <div className="flex items-start justify-between">
          ...
          >
            <UtensilsCrossed className="size-3 text-[var(--color-accent)]" />
            For Restaurants &amp; Hospitality · 2026 Edition
          </motion.div>
        </div>
        ...
        <div>
          ...
          >
            <span className="text-gradient-brand">Treat every guest</span>
            <br />
            <span className="text-gradient">like a regular.</span>
            <br />
            Automatically.
          </motion.h1>
          ...
          >
            A boutique AI consultancy that builds voice booking agents, loyalty
            engines, reputation management systems, and guest recognition
            workflows for restaurants, cafés, and hospitality businesses.
            Everything wires directly into your POS, WhatsApp, and booking systems.
          </motion.p>
        </div>
