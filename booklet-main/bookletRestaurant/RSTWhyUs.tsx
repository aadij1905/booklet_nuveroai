...
const valueProps = [
  {
    ...
    body: "Strategy sprints from $4k. Custom builds $8k–$30k for most hospitality engagements. Boutique outcomes at a fraction of enterprise AI pricing.",
    accent: "brand" as const,
  },
  {
    icon: Layers,
    title: "Restaurant-specific, not generic",
    body: "Every bot, agent, and workflow is trained on your actual menu, service style, and guest communication tone. No cookie-cutter chatbots.",
    accent: "accent" as const,
  },
  {
    icon: ShieldCheck,
    title: "Shipped, not stalled",
    body: "Live in your restaurant in 3–6 weeks. No 80-slide strategy decks before something actually ships. Weekly demos from day one.",
    accent: "brand" as const,
  },
  {
    icon: InfinityIcon,
    title: "Owned, not rented",
    body: "Code, data, and integrations live in your cloud accounts. No vendor lock-in, no per-seat tax as you open more locations.",
    accent: "accent" as const,
  },
];
