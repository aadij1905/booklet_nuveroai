...
const approach = [
  "AI voice agent wired into the restaurant's reservation system and POS",
  "Guest recognition layer: visit history, preferences, allergies surfaced automatically",
  "WhatsApp-based post-visit feedback and occasion-triggered outreach",
  "Review monitoring across Google, Zomato, and Instagram with AI-drafted responses",
  "Dynamic pricing dashboard: targeted offers for slow periods, margin protection on peak nights",
];

const tech = ["VAPI", "Twilio", "WhatsApp Cloud API", "Claude", "Supabase", "POS Integration"];

export function RSTCaseStudy() {
  return (
    <Poster page="06 / 08" section="What This Looks Like">
      ...
      >
        <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-[var(--color-accent-strong)]">
          Multi-Location Restaurant · 3–5 Outlets
        </div>
        <h2 className="poster-title mt-2 text-[34px] leading-[1.08] tracking-tight">
          <span className="text-gradient">Full-Stack Restaurant AI</span>
        </h2>
      </motion.div>
      ...
      >
        Voice booking + guest recognition + review management for a busy restaurant group
      </motion.p>
      ...
      >
        This is a detailed walkthrough of what a full implementation looks like for a
        restaurant group handling 200+ covers per night across multiple locations.
        This is presented as a concept build — clearly labeled because we believe in
        showing realistic scope, not inventing results.
      </motion.p>
      ...
      >
        <p className="text-[11px] leading-[1.6] text-[var(--color-fg)]">
          ...
          names, statistics, or testimonials. When we have a real hospitality
        ...
        >
          <div className="flex-1 rounded-xl border border-[var(--color-border-strong)] bg-[linear-gradient(135deg,rgba(139,92,246,0.12),rgba(34,211,238,0.08))] p-4">
            ...
            <ul className="mt-2 flex flex-col gap-1.5">
              <li className="text-[11px] leading-[1.5] text-[var(--color-fg)]">
                • Zero missed reservation calls during peak service
              </li>
              <li className="text-[11px] leading-[1.5] text-[var(--color-fg)]">
                • Regulars recognized automatically — preferences surfaced before seating
              </li>
              <li className="text-[11px] leading-[1.5] text-[var(--color-fg)]">
                • Every review responded to within 2 hours, not 2 days
              </li>
            </ul>
          </div>
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-elev)] p-3">
            <p className="text-[10px] leading-[1.55] text-[var(--color-fg-muted)]">
              This is the same playbook we&rsquo;d run for your restaurant: your
              POS in, your reservation system in, your guest data wired in, and a
              clean handoff to your team for every moment that deserves a human —
              which is always the table-side experience itself.
            </p>
          </div>
        </motion.div>
      </div>
