  ...
  return (
    <Poster page="08 / 08" section="The Next Move" showWatermark={false}>
      ...
      <div className="flex h-full min-h-[260mm] flex-col">
        ...
        >
          Let&rsquo;s make your restaurant
          <br />
          <span className="text-gradient">feel like it never sleeps.</span>
        </motion.h2>
        ...
        >
          ...
          bottleneck. One 20–30 minute discovery call, no slides, no NDA. We&rsquo;ll
          map the two or three highest-leverage AI opportunities in your operation
          and tell you straight whether it&rsquo;s worth shipping, what it&rsquo;ll
